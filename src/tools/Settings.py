...
class Settings:
    ...
    _FILE_LOG_OUT_TMPL = 'raspi-surveillance.application-{}.log'
    ...
    def __init__(self,
        ...
        self.sync_whitelist_file_prefixes = []
        self.sync_whitelist_file_suffixes = ['.png', '.jpg', '.jpeg', '.gif', '.mp4']
        self.sync_whitelist_file_names = []
        self.sync_blacklist_folder_prefixes = ['.', '@']
        self.sync_blacklist_folder_suffixes = ['~']
        self.sync_blacklist_folder_names = ['__pycache__']
    ...
    def get_sender(self, sender, key, default=''):
        ...
        """
        try:
            return self._settings_dict['senders'][sender][key]
        except KeyError as exception:
